...
public class Transforms2D extends JPanel {
    ...
    private class Display extends JPanel {
        protected void paintComponent(Graphics g) {
            ...
            int polygonNumberOfSpikes = 9;
            int[] spikesXCoords = new int[10];
            int[] spikesYCoords = new int[10];

            for (int spike = 0; spike < polygonNumberOfSpikes; spike++) {
                spikesXCoords[spike] = (int) Math.round(polygonRadius * Math.cos(2 * Math.PI * spike / 9));
                spikesYCoords[spike] = (int) Math.round(polygonRadius * Math.sin(2 * Math.PI * spike / 9));
            }
